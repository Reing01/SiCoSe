...
ciudadanosRouter.use(requireResource("ciudadanos"));
...
ciudadanosRouter.post("/", async (request, response, next) => {
  try {
...
ciudadanosRouter.put("/:id", async (request, response, next) => {
  try {
    const ciudadanoId = getParamId(request.params.id);
...
ciudadanosRouter.put("/:id/desactivar", async (request, response, next) => {
  try {
    const ciudadanoId = getParamId(request.params.id);
