...
async function measureProbe(probe: HealthProbe, timeoutMs = HEALTH_CHECK_TIMEOUT_MS): Promise<HealthProbeResult> {
...
export async function getReadinessReport(dependencies: ReadinessDependencies = {}): Promise<ReadinessReport> {
